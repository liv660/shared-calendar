...
public class AuthController {
    ...
    public ResponseEntity<AuthTokenResponse> refreshToken(@Parameter(required = true) @Valid @RequestBody RefreshRequest token) throws ParseException, JOSEException {
